...
if(isset($_POST['submit'])){
   ...
   $select_manager = $conn->prepare("SELECT * FROM `product_manager` WHERE name = ? AND password = ?");
   $select_manager->execute([$name, $pass]);
   $row = $select_manager->fetch(PDO::FETCH_ASSOC);
...
<head>
   ...
   <title>Keens | Product Manager Login</title>
                ...
                <div class="card border-0 rounded-4 overflow-hidden" 
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold mb-1" style="color: #2b3452;">Product Manager Login</h3>
