...
if(isset($_POST['submit'])){
   ...
   $select_supplier = $conn->prepare("SELECT * FROM `suppliers` WHERE email = ? AND password = ?");
   $select_supplier->execute([$email, $pass]);
   $row = $select_supplier->fetch(PDO::FETCH_ASSOC);
...
<head>
   ...
   <title>Keens | Supplier Login</title>
                ...
                <div class="card border-0 rounded-4 overflow-hidden" 
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold mb-1" style="color: #2b3452;">Keens Supplier Portal</h3>
