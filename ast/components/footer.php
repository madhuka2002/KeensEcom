   ...
   <div class="container">
      ...
      <div class="row mb-5">
         <div class="col-lg-4 mb-4 mb-lg-0">
            ...
            ">
                Keens<span style="color: #2575fc;">.lk</span>
            </a>
            </h2>
         ...
         <div class="col-6 col-lg-2 mb-4 mb-lg-0">
            ...
            <ul class="list-unstyled" style="margin: 0; padding: 0;">
               <li class="mb-3">
                  <a href="ticket.php" class="text-decoration-none d-block" style="color: #999999; transition: all 0.3s ease;">Tickets / Inquiries</a>
               </li>
               <li class="mb-3">
                  <a href="portal.php" class="text-decoration-none d-block" style="color: #999999; transition: all 0.3s ease;">Portal</a>
               </li>
            </ul>
         </div>
         ...
         <div class="col-lg-4">
            ...
            <div class="d-flex flex-column gap-3">
               ...
               <div class="d-flex align-items-center gap-3">
                  ...
                  <div style="color: #999999;">
                     <a href="mailto:contact@keens.lk" style="text-decoration: none; color: #999999;">contact@keens.lk</a>
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="row align-items-center">
         <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <p class="mb-0" style="color: #999999;">
               Copyright © <span style="color: #0d6efd;"><?= date('Y'); ?></span> Keens. All rights reserved.
            </p>
         </div>
