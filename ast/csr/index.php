...
if(isset($_POST['submit'])){
   ...
   $select_csr = $conn->prepare("SELECT * FROM `customer_sales_representatives` WHERE name = ? AND password = ?");
   $select_csr->execute([$name, $pass]);
   $row = $select_csr->fetch(PDO::FETCH_ASSOC);

   if($select_csr->rowCount() > 0){
      $_SESSION['csr_id'] = $row['csr_id'];
                ...
                <div class="card border-0 rounded-4 overflow-hidden" 
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold mb-1" style="color: #2b3452;">Sales Representative Login</h3>
