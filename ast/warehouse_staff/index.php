...
if(isset($_POST['submit'])){
   ...
   $select_staff = $conn->prepare("SELECT * FROM `warehouse_staff` WHERE phone = ? AND password = ?");
   $select_staff->execute([$phone, $pass]);
   $row = $select_staff->fetch(PDO::FETCH_ASSOC);

   if($select_staff->rowCount() > 0){
      $_SESSION['staff_id'] = $row['staff_id'];
      header('location:warehouse_staff_dashboard.php');
   }else{
                ...
                <div class="card border-0 rounded-4 overflow-hidden" 
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <h3 class="fw-bold mb-1" style="color: #2b3452;">Warehouse Staff Login</h3>
